...
// Some local IntelliSense/build setups lose this macro from stb_textedit even though
// the bundled header defines it. Keep a tiny compatibility fallback so imgui stays buildable.
